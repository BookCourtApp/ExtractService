...
public class ExtractorLiveLib : IExtractor<IDocument, Book>
{
    ...
    public async Task<IDocument> GetRawDataAsync(ResourceInfo resourceInfo)
    {
        ...
        try
        {
            //var proxy = new WebProxy("91.243.188.30:7951");
        ...
        string headers = //"Sec-Ch-Ua: "Not:A-Brand";v="99", "Chromium";v="112"
            ...
            "Referer: google.com";// "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7 \n ";
